         ...
         ['widget': 'tab', attrs: [label: 'Resultados'], widgets: [
                 ['widget': 'tabs', attrs: [id : 'results'], widgets: [
                         ['widget': 'tab', attrs: [label: 'Planilhas da eficiência e custo'], widgets: [
                                 ...
                                 ['widget': 'tableReport',attrs: [header: ['label': 'Índice', 'totalValue': 'Valor Total'], data: [[label: 'Índice de eficiência da produção', totalValue: vars['cost_production_efficiency']]]]],
                                 ['widget': 'ln'],
                                 ...
                                 ['widget': 'tableReport',attrs: [header: ['label': 'Índice', 'totalValue': 'Valor Total'], data: [[label: 'Índice de tecnológica no campo', totalValue: vars['technologicalEfficiencyInTheField']]]]],
                                 ['widget': 'ln'],
                                 ...
                                 ['widget': 'tableReport',attrs: [header: ['label': 'Índice', 'totalValue': 'Valor Total'], data: [[label: 'Índice de tecnológica na industria', totalValue: vars['technologicalEfficiencyInTheIndustrial']]]]],
                                 ['widget': 'ln'],
                                 ['widget': 'text',       attrs: [text: '**Avaliação da eficiência**']],
                                 ['widget': 'tableReport',attrs: [header: ['label': 'Índice', 'totalValue': 'Valor Total'], data: [[label: 'Índice de eficiência da produção', totalValue: vars['cost_production_efficiency']],
                                                                                                                                   [label: 'Índice de eficiência tecnológica no campo', totalValue: vars['technologicalEfficiencyInTheField']],
                                                                                                                                   [label: 'Índice de eficiência tecnológica na industria', totalValue: vars['technologicalEfficiencyInTheIndustrial']],
                                                                                                                                   [label: 'Índice da eficiência', totalValue: vars['efficiency']]]]],
                         ...
                         ['widget': 'tab', attrs: [label: 'Planilhas da sustentabilidade'], widgets: [
                                 ...
                                 ['widget': 'tableReport',attrs: [header: ['label': 'Indicador', 'relevance': 'Relevância', 'valueTypeLabel': 'Valor cadastrado', 'value': 'Valor', 'totalValue': 'Valor total'], data: dataReader.':SocialIndicator']],
