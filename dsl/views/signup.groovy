...
form([id: 'signUpForm', action: '/user/createUser'], [[widget: 'formGroup', attrs: [widgetName: 'textForm', model: [label: 'Nome:', placeholder: 'Nome', required: true, id: 'http://purl.org/biodiv/semanticUI#hasName']]],
                                                      ...
                                                      [widget: 'formGroup', attrs: [widgetName: 'textForm', model: [label: 'Instituição / Organização:', placeholder: 'Organização ou institução', required: false, id: 'http://purl.org/biodiv/semanticUI#hasOrganization']]],
                                                      ...
                                                      [widget: 'formGroup', attrs: [widgetName: 'textForm', model: [label: 'Número de telefone:', placeholder: 'Número com DDD', required: false, id: 'http://purl.org/biodiv/semanticUI#hasPhoneNumber']]],
                                                      ...
                                                      [widget: 'formGroup', attrs: [widgetName: 'checkboxForm', model: [label: 'Você concorda com os nossos termos de uso', required: true, id: 'http://purl.org/biodiv/semanticUI#hasTermsofuse', value: 'yes']]],
