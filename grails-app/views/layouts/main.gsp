			...
			<div class="navbar navbar-default" role="navigation">
				<div class="container-fluid">
				  <div class="navbar-header">
				    ...
				    <a class="navbar-brand" href="/sustenagro/">
				    	<g:img dir='images' file='logo.png' class="logo" />
				   	</a>
				  </div>
				  <div class="navbar-collapse collapse">
				    <ul class="nav navbar-nav">
				      <li <g:if test="${controllerName == null}"> class="active" </g:if> ><a href="/sustenagro/">Inicio</a></li>
				      <li <g:if test="${controllerName == 'tool'}"> class="active" </g:if> ><a href="/sustenagro/tool">Ferramenta</a></li>
				      ...
				      <li <g:if test="${controllerName == 'contact'}"> class="active" </g:if> ><a href="/sustenagro/contact">Contato</a></li>
				    </ul>
