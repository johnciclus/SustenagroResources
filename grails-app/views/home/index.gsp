    ...
    <body>
        <div class="row main">
            <div class="col-sm-5 col-sm-offset-1 left-content">
                <h5 class="text-primary page-header">Método SustenAgro – Avaliação da sustentabilidade da Agricultura</h5>
                <p>A avaliação da sustentabilidade dos sistemas agrícolas pode ser uma aliada ao processo de decisão. Este Software apresenta uma metodologia para a avaliação da sustentabilidade dos sistemas de produção de cana-de-açúcar do Centro-Sul do Brasil, fornecendo informações organizadas de acordo com critérios e indicadores nas diversas dimensões onde os efeitos do sistema sob avaliação podem ser percebidos.</p>
                <p>Essas informações estão organizadas em três ferramentas:</p>
                <ol>
                    <li>Planilhas para análise da Eficiência tecnológica e de custos do sistema agrícola (Índice de Eficiência do Sistema Agroindustrial de cana-de-açúcar)</li>
                    <li>planilhas para avaliação dos indicadores de sustentabilidade para geração do Índice de Sustentabilidade, finalmente, a combinação deste dois índices (Eficiência do Sistema Agroindustrial de cana X Sustentabilidade) possibilitam a apresentação dos resultados na Matriz de Sustentabilidade</li>
                ...
                <p>A validação geral dos indicadores foi realizada a partir de consulta remota, na qual foi empregada a Técnica Delphi de consulta a especialistas.</p>
            ...
            <div class="col-sm-5 right-content">
                ...
                <ul>
                    ...
                    <li>Universidade Federal de São Carlos (UFSCar) / Instituto de Computação (campus São Carlos)</li>
                    <li>Instituto de Economia Agrícola (IEA / APTA)</li>
                    <li>Centro de Tecnologia do BioEtanol (CTBE).</li>
                    <li>Agencia Paulista de Tecnologia dos Agronegócios - Pólo Centro Sul/DDD/APTA – UPD Tietê APTA/SP</li>
                    <li>Embrapa Meio Ambiente</li>
                    <li>Embrapa Informática</li>
                    <li>Embrapa Trigo</li>
                </ul>
