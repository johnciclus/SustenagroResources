<p>
    \[EficiênciaNoCampo = \sum_{i=1}^n CaracterísticasDoSistema_i * AlinhamentoAoAmbiente_i \]

    \[EficiênciaNaIndústria = \sum_{i=1}^n CaracterísticasIndustriais_i * OtimizaçãoDoProcessamento_i \]
