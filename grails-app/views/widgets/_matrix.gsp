<div class="section">
    ...
    <script type="text/javascript">
        ...
        $("#recomendations").append("<p>" + <g:message code="matrix.quadrant" /> + ": "+result.quadrant+"</p>");
        $("#recomendations").append("<p>" + <g:message code="matrix.recommendation" /> + ": "+result.recomendation+"</p>");
    </script>
</div>